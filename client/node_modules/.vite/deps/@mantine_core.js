...
function calculateInitialPosition(el, options) {
	...
	else x = px$1(style.left) || winW - rect.width - px$1(style.right) || offset;
	if (top != null) y = top;
	else if (bottom != null) y = winH - rect.height - bottom;
	else y = px$1(style.top) || winH - rect.height - px$1(style.bottom) || offset;
...
function createSetPosition(elRef, posRef, options) {
	return (0, import_react.useCallback)((position) => {
...
var Collapse = factory((props) => {
	const { children, expanded, transitionDuration, transitionTimingFunction, style, onTransitionEnd, onTransitionStart, animateOpacity, keepMounted, ref, orientation, ...others } = useProps("Collapse", defaultProps$113, props);
...
function ScrollAreaRoot(_props) {
	const { type, scrollHideDelay, scrollbars, getStyles, ref, ...others } = useProps("ScrollAreaRoot", defaultProps$112, _props);
...
var ScrollArea = factory((_props) => {
	const props = useProps("ScrollArea", defaultProps$111, _props);
...
var defaultProps$110 = { __staticSelector: "UnstyledButton" };
var UnstyledButton = polymorphicFactory((_props) => {
	const props = useProps("UnstyledButton", defaultProps$110, _props);
...
var defaultProps$109 = { zIndex: getDefaultZIndex("modal") };
...
var Overlay = polymorphicFactory((_props) => {
	const props = useProps("Overlay", defaultProps$109, _props);
...
var defaultProps$108 = { reuseTargetNode: true };
var Portal = factory((props) => {
	const { children, target, reuseTargetNode, ref, ...others } = useProps("Portal", defaultProps$108, props);
	const [mounted, setMounted] = (0, import_react.useState)(false);
...
var PopoverTarget = factory((props) => {
	const { children, refProp, popupType, ref, ...others } = useProps("PopoverTarget", defaultProps$107, props);
	const child = getSingleElementChild(children);
...
function Popover(_props) {
	const props = useProps("Popover", defaultProps$106, _props);
...
var Loader = factory((_props) => {
	const props = useProps("Loader", defaultProps$105, _props);
...
var defaultProps$104 = { orientation: "horizontal" };
...
var ActionIconGroup = factory((_props) => {
	const props = useProps("ActionIconGroup", defaultProps$104, _props);
	const { className, style, classNames, styles, unstyled, orientation, vars, borderWidth, variant, mod, attributes, ...others } = useProps("ActionIconGroup", defaultProps$104, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
...
var defaultProps$103 = { variant: "subtle" };
...
var CloseButton = polymorphicFactory((_props) => {
	const props = useProps("CloseButton", defaultProps$103, _props);
...
var Group = factory((_props) => {
	const props = useProps("Group", defaultProps$102, _props);
...
var defaultProps$101 = { labelElement: "label" };
var varsResolver$80 = createVarsResolver((_, { size }) => ({ label: {
	"--input-label-size": getFontSize(size),
	"--input-asterisk-color": void 0
} }));
var InputLabel = factory((_props) => {
	const props = useProps("InputLabel", defaultProps$101, _props);
...
var InputWrapper = factory((_props) => {
	const props = useProps("InputWrapper", defaultProps$100, _props);
...
var Input = polymorphicFactory((_props) => {
	const props = useProps("Input", defaultProps$99, _props);
...
var InputBase = polymorphicFactory((props) => {
	const { inputProps, wrapperProps, ...others } = useInputProps("InputBase", defaultProps$98, props);
...
var Accordion = genericFactory((_props) => {
	const props = useProps("Accordion", defaultProps$97, _props);
...
var Affix = factory((_props) => {
	const props = useProps("Affix", defaultProps$96, _props);
...
var defaultProps$95 = { inherit: false };
...
var Text = polymorphicFactory((_props) => {
	const props = useProps("Text", defaultProps$95, _props);
...
var defaultProps$94 = { underline: "hover" };
var Anchor = polymorphicFactory((props) => {
	const { underline, className, unstyled, mod, ...others } = useProps("Anchor", defaultProps$94, props);
...
var AngleSlider = factory((_props) => {
	const props = useProps("AngleSlider", defaultProps$93, _props);
...
var AppShell = factory((_props) => {
	const props = useProps("AppShell", defaultProps$92, _props);
...
var defaultProps$91 = { error: null };
...
var ComboboxChevron = factory((_props) => {
	const props = useProps("ComboboxChevron", defaultProps$91, _props);
...
var defaultProps$90 = { refProp: "ref" };
var ComboboxDropdownTarget = factory((props) => {
	const { children, refProp, ref } = useProps("ComboboxDropdownTarget", defaultProps$90, props);
	useComboboxContext();
...
var ComboboxEventsTarget = factory((props) => {
	const { children, refProp, withKeyboardNavigation, withAriaAttributes, withExpandedAttribute, targetType, autoComplete, ref, ...others } = useProps("ComboboxEventsTarget", defaultProps$89, props);
	const child = getSingleElementChild(children);
...
var ComboboxSearch = factory((_props) => {
	const { classNames, styles, unstyled, vars, withAriaAttributes, onKeyDown, withKeyboardNavigation, size, ref, ...others } = useProps("ComboboxSearch", defaultProps$88, _props);
	const ctx = useComboboxContext();
...
var ComboboxTarget = factory((props) => {
	const { children, refProp, withKeyboardNavigation, withAriaAttributes, withExpandedAttribute, targetType, autoComplete, ref, ...others } = useProps("ComboboxTarget", defaultProps$87, props);
	const child = getSingleElementChild(children);
...
var Combobox = (_props) => {
	const props = useProps("Combobox", defaultProps$86, _props);
...
var defaultProps$85 = { hiddenInputValuesSeparator: "," };
var CheckboxGroup = genericFactory(((props) => {
	const { value, defaultValue, onChange, size, wrapperProps, children, readOnly, name, hiddenInputValuesSeparator, hiddenInputProps, maxSelectedValues, disabled, ...others } = useProps("CheckboxGroup", defaultProps$85, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: [],
...
var CheckboxIndicator = factory((_props) => {
	const props = useProps("CheckboxIndicator", defaultProps$83, _props);
...
var Checkbox = factory((_props) => {
	const props = useProps("Checkbox", defaultProps$82, _props);
...
var defaultProps$81 = { iconSize: 48 };
...
var Blockquote = factory((_props) => {
	const props = useProps("Blockquote", defaultProps$81, _props);
...
var Breadcrumbs = factory((_props) => {
	const props = useProps("Breadcrumbs", defaultProps$80, _props);
...
var defaultProps$79 = { orientation: "horizontal" };
...
var ButtonGroup = factory((_props) => {
	const props = useProps("ButtonGroup", defaultProps$79, _props);
	const { className, style, classNames, styles, unstyled, orientation, vars, borderWidth, mod, attributes, ...others } = useProps("ButtonGroup", defaultProps$79, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
			name: "ButtonGroup",
			props,
...
var defaultProps$78 = { orientation: "vertical" };
var Card = polymorphicFactory((_props) => {
	const props = useProps("Card", defaultProps$78, _props);
...
var defaultProps$77 = { type: "checkbox" };
...
var Chip = factory((_props) => {
	const props = useProps("Chip", defaultProps$77, _props);
...
var defaultProps$76 = { withShadow: true };
...
var ColorSwatch = polymorphicFactory((_props) => {
	const props = useProps("ColorSwatch", defaultProps$76, _props);
	const { classNames, className, style, styles, unstyled, vars, color, radius, withShadow, children, attributes, ...others } = useProps("ColorSwatch", defaultProps$76, props);
	const getStyles = useStyles({
		name: "ColorSwatch",
		props,
...
var defaultProps$75 = { __staticSelector: "AlphaSlider" };
var AlphaSlider = factory((props) => {
	const { value, onChange, onChangeEnd, color, ...others } = useProps("AlphaSlider", defaultProps$75, props);
...
var defaultProps$74 = { __staticSelector: "HueSlider" };
var HueSlider = factory((props) => {
	const { value, onChange, onChangeEnd, color, ...others } = useProps("HueSlider", defaultProps$74, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ColorSlider, {
		...others,
		value,
		onChange,
...
var ColorPicker = factory((_props) => {
	const props = useProps("ColorPicker", defaultProps$73, _props);
...
var defaultProps$71 = { strategy: "block" };
...
var Container = factory((_props) => {
	const props = useProps("Container", defaultProps$71, _props);
...
var defaultProps$70 = { timeout: 1e3 };
function CopyButton(props) {
	const { children, timeout, value, ...others } = useProps("CopyButton", defaultProps$70, props);
...
var Dialog = factory((_props) => {
	const props = useProps("Dialog", defaultProps$69, _props);
...
var defaultProps$68 = { orientation: "horizontal" };
...
var Divider = factory((_props) => {
	const props = useProps("Divider", defaultProps$68, _props);
...
var DrawerRoot = factory((_props) => {
	const props = useProps("DrawerRoot", defaultProps$67, _props);
...
var Drawer = factory((_props) => {
	const { title, withOverlay, overlayProps, withCloseButton, closeButtonProps, children, opened, stackId, zIndex, ...others } = useProps("Drawer", defaultProps$66, _props);
...
var defaultProps$65 = { variant: "default" };
...
var Fieldset = factory((_props) => {
	const props = useProps("Fieldset", defaultProps$65, _props);
...
var FileInput = genericFactory((_props) => {
	const props = useProps("FileInput", defaultProps$64, _props);
...
var FloatingWindow = factory((_props) => {
	const props = useProps("FloatingWindow", defaultProps$63, _props);
...
var defaultProps$62 = { span: 12 };
var GridCol = factory((_props) => {
	const { classNames, className, style, styles, vars, span, order, offset, align, ...others } = useProps("GridCol", defaultProps$62, _props);
	const ctx = useGridContext();
	const responsiveClassName = useRandomClassName();
...
var Grid = factory((_props) => {
	const props = useProps("Grid", defaultProps$61, _props);
...
var defaultProps$60 = { color: "yellow" };
...
var Mark = factory((_props) => {
	const props = useProps("Mark", defaultProps$60, _props);
...
var Highlight = polymorphicFactory((_props) => {
	const { unstyled, children, highlight, highlightStyles, color, wholeWord, ...others } = useProps("Highlight", defaultProps$59, _props);
...
function HoverCardGroup(props) {
	const { openDelay, closeDelay, children } = useProps("HoverCardGroup", defaultProps$58, props);
...
var defaultProps$57 = { refProp: "ref" };
function HoverCardTarget(props) {
	const { children, refProp, eventPropsWrapperName, ...others } = useProps("HoverCardTarget", defaultProps$57, props);
	const child = getSingleElementChild(children);
...
function HoverCard(props) {
	const { children, onOpen, onClose, openDelay, closeDelay, initiallyOpened, ...others } = useProps("HoverCard", defaultProps$56, props);
...
var Indicator = factory((_props) => {
	const props = useProps("Indicator", defaultProps$55, _props);
...
var defaultProps$54 = { size: "sm" };
var Textarea = factory((props) => {
	const { autosize, maxRows, minRows, __staticSelector, resize, ...others } = useProps("Textarea", defaultProps$54, props);
...
var JsonInput = factory((props) => {
	const { value, defaultValue, onChange, formatOnBlur, validationError, serialize, deserialize, onFocus, onBlur, readOnly, error, indentSpaces, ...others } = useProps("JsonInput", defaultProps$53, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: "",
...
var defaultProps$52 = { type: "unordered" };
...
var List = factory((_props) => {
	const props = useProps("List", defaultProps$52, _props);
...
var LoadingOverlay = factory((_props) => {
	const props = useProps("LoadingOverlay", defaultProps$51, _props);
...
var Marquee = factory((_props) => {
	const props = useProps("Marquee", defaultProps$50, _props);
...
var TabsPanel = factory((_props) => {
	...
	const content = shouldKeepMounted && env !== "test" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Activity, {
